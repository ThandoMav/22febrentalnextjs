...
export default function AdminProductEditScreen() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const { data } = await axios.get(`/api/admin/rentals/${productId}`);
        ...
        setValue('garage', data.garage);
        setValue('lounge', data.lounge);
        setValue('drName', data.drName);
  ...
  const submitHandler = async ({
    ...
    try {
      ...
      await axios.put(`/api/admin/rentals/${productId}`, {
        name,
    slug,
    price,
    category,
  ...
  return (
    <Layout title={`Edit Rental ${productId}`}>
            ...
            >
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="sqm"
                  {...register('sqm', {
                    required: 'Please enter sqm',
                  })}
                />
                {errors.sqm && (
                  <div className="text-red-500">{errors.sqm.message}</div>
                )}
              </div>
              <div className="mb-4">
                ...
                <input
                  ...
                  id="kitchen"
                  {...register('kitchen', {
                    required: 'Please enter kitchen',
                  })}
                />
                {errors.kitchen && (
                  <div className="text-red-500">{errors.kitchen.message}</div>
                )}
              </div>
              <div className="mb-4">
                ...
                />
                {errors.bedroom && (
                  <div className="text-red-500">{errors.bedroom.message}</div>
                )}
              </div>
              <div className="mb-4">
                ...
                />
                {errors.bathroom && (
                  <div className="text-red-500">{errors.bathroom.message}</div>
                )}
              </div>
              <div className="mb-4">
                ...
                />
                {errors.garage && (
                  <div className="text-red-500">{errors.garage.message}</div>
                )}
              </div>
              <div className="mb-4">
                ...
                <input
                  ...
                  id="lounge"
                  {...register('lounge', {
                    required: 'Please enter lounge',
                  })}
                />
                {errors.lounge && (
                  <div className="text-red-500">{errors.lounge.message}</div>
                )}
              </div>
