...
export default function AdminProductEditScreen() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const { data } = await axios.get(`/api/admin/home-services/${productId}`);
  ...
  const submitHandler = async ({
    ...
    try {
      ...
      await axios.put(`/api/admin/home-services/${productId}`, {
        name,
    slug,
    price,
    category,
  ...
  return (
    <Layout title={`Edit home-service ${productId}`}>
      <div className="grid md:grid-cols-4 md:gap-5 py-2 mt-6 px-6  md:mt-32 md:px-32">
        ...
        <div className="md:col-span-3">
          {loading ? (
            ...
            >
              <h1 className="mb-4 text-xl">{`Edit home-service  ${productId}`}</h1>
              <div className="mb-4">
              ...
              <div className="mb-4">
                <Link href={`/admin/home-services`}>Back</Link>
              </div>
            </form>
          )}
        </div>
