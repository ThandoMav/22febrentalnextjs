...
export default function AdminProdcutsScreen() {
  ...
  const createHandler = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(`/api/admin/home-services`);
      dispatch({ type: 'CREATE_SUCCESS' });
      toast.success('Product created successfully');
      router.push(`/admin/home-service/${data.product._id}`);
    } catch (err) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const { data } = await axios.get(`/api/admin/home-services`);
  ...
  const deleteHandler = async (productId) => {
    ...
    try {
      ...
      await axios.delete(`/api/admin/home-services/${productId}`);
