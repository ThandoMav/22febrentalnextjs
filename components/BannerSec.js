        ...
        <div className="flex items-center h-full relative -space-x-48 lg:-space-x-24">
          <div className="text-white flex-1 z-10 pl-6 lg:pl-0">
            <h1
              ...
              data-aos-delay="500"
            >
              Find Reliable Homes, Services  <br />
              <span className="text-primary-200">& Transport While Embracing Your Roots!</span>
            </h1>
            <p
              ...
              data-aos-delay="600"
            >
              Browse verified listings. Hire trusted service providers. Make smart, faith-based life decisions.
            </p>
            <button
