...
const postSchema = new mongoose.Schema(
  {
    ...
    garage: { type: Number, required: true, default: 0 },
    lounge: { type: Number, required: true, default: 0 },
...
const Rental = mongoose.models.Rental || mongoose.model('Rental', postSchema);
